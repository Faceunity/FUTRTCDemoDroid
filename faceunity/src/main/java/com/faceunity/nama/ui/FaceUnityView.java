...
public class FaceUnityView extends FrameLayout {
    ...
    private void initView() {
        ...
        beautyControlView = (BeautyControlView) view.findViewById(R.id.beauty_control_view);
        bodySlimControlView = (BeautifyBodyControlView) view.findViewById(R.id.body_slim_control_view);

        rvStickEffect = (RecyclerView) view.findViewById(R.id.rv_sticker_effect);
        ...
        final EffectListAdapter effectListAdapter = new EffectListAdapter(StickerEnum.getStickers());
        ...
        RecyclerView rvMakeup = (RecyclerView) view.findViewById(R.id.rv_makeup);
        ...
        makeupSeekBar = (DiscreteSeekBar) view.findViewById(R.id.makeup_seek_bar);
        makeupSeekBar.setOnProgressChangeListener(new MakeupSeekChangedListener());
        makeupSeekBar.setProgress(100);

        CheckGroup checkGroup = (CheckGroup) view.findViewById(R.id.cg_nav_bar);
