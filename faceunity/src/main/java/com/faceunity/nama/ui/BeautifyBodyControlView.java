...
public class BeautifyBodyControlView extends FrameLayout {
    ...
    private void initView() {
        ...
        mSeekBar = (DiscreteSeekBar) findViewById(R.id.seek_bar_beauty_body);
        mSeekBar.setOnProgressChangeListener(new ProgressChangeListener());

        mBeautyBoxGroup = (BeautyBoxGroup) findViewById(R.id.beauty_group_body);
        mBeautyBoxGroup.setOnCheckedChangeListener(new CheckChangeListener());
        mBbShoulder = (BeautyBox) mBeautyBoxGroup.findViewById(R.id.beauty_box_beauty_shoulder);
        mBbBodySlim = (BeautyBox) mBeautyBoxGroup.findViewById(R.id.beauty_box_body_slim);
        mBbLegSlim = (BeautyBox) mBeautyBoxGroup.findViewById(R.id.beauty_box_long_leg);
        mBbThinWaist = (BeautyBox) mBeautyBoxGroup.findViewById(R.id.beauty_box_thin_waist);
        mBbHipSlim = (BeautyBox) mBeautyBoxGroup.findViewById(R.id.beauty_box_hip_slim);
        mBbHead = (BeautyBox) mBeautyBoxGroup.findViewById(R.id.beauty_box_head_slim);
        mBbLegThin = (BeautyBox) mBeautyBoxGroup.findViewById(R.id.beauty_box_leg_thin_slim);

        mIvRecover = (ImageView) findViewById(R.id.iv_recover_body);
        mTvRecover = (TextView) findViewById(R.id.tv_recover_body);
