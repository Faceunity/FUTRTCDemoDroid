...
public class BeautyControlView extends FrameLayout implements TouchStateImageView.OnTouchStateListener {
    ...
    private void initView() {
        ...
        mIvCompare = (TouchStateImageView) findViewById(R.id.iv_compare);
    ...
    private void initViewSkinBeauty() {
        mFlFaceSkinItems = (FrameLayout) findViewById(R.id.fl_face_skin_items);
        mIvRecoverFaceSkin = (ImageView) findViewById(R.id.iv_recover_face_skin);
        ...
        mTvRecoverFaceSkin = (TextView) findViewById(R.id.tv_recover_face_skin);
    ...
    private void initViewFaceShape() {
        mFlFaceShapeItems = (FrameLayout) findViewById(R.id.fl_face_shape_items);
        mIvRecoverFaceShape = (ImageView) findViewById(R.id.iv_recover_face_shape);
        ...
        mTvRecoverFaceShape = (TextView) findViewById(R.id.tv_recover_face_shape);
        mShapeBeautyBoxGroup = (BeautyBoxGroup) findViewById(R.id.beauty_group_face_shape);
