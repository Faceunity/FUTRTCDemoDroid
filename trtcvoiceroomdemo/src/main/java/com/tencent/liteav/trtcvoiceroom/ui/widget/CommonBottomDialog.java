...
public class CommonBottomDialog extends BottomSheetDialog {
    ...
    public void setButton(OnButtonClickListener buttonClickListener, String... textList) {
        ...
        for (int i = 0; i < mButtonSize; i++) {
            ...
            //            } else {
            //                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            //                lp.setMargins(dp2px(getContext(), 10), dp2px(getContext(), 5), dp2px(getContext(), 10), dp2px(getContext(), 10));
            //                textView.setPadding(dp2px(getContext(), 5), dp2px(getContext(), 5), dp2px(getContext(), 5), dp2px(getContext(), 5));
            //                textView.setLayoutParams(lp);
            //            }
        }
    }
